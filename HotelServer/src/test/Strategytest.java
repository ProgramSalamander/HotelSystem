...
public class Strategytest {
	...
	public void testisHotelstrategy_make(){
		MockHotelStrategy1 hs=new MockHotelStrategy1("开业酬宾","无","2016-10-14-0:00","2016-10-20-0:00","九折",false);
		assertEquals(ResultMessage.Success,strategyblImpl.hotelstrategy_make(hs));
	}
	
	@Test
	public void testisHotelstrategy_update(){
		MockHotelStrategy1 hs=new MockHotelStrategy1("开业酬宾","无","2016-10-14-0:00","2016-10-20-0:00","八折",false);
		assertEquals(ResultMessage.Success,strategyblImpl.hotelstrategy_update(hs));
	}
	
	@Test
	public void testisWebstrategy_make(){
		MockWebStrategy1 ws=new MockWebStrategy1("开业酬宾","无","2016-10-14-0:00","2016-10-20-0:00","九折",false);
		assertEquals(ResultMessage.Success,strategyblImpl.webstrategy_make(ws));
	}
	
	@Test
	public void testisWebstrategy_update(){
		MockWebStrategy1 ws=new MockWebStrategy1("开业酬宾","无","2016-10-14-0:00","2016-10-20-0:00","八折",false);
